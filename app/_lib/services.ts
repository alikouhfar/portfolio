...
export const services: IService[] = [
  ...
  },
  {
    ...
    description:
      "Assesses websites for vulnerabilities and implements fixes to protect data and maintain user trust.",
  },
  {
    id: 10,
    category: "Animation",
    ...
    description:
      "Enhances user engagement with animated elements and transitions for a dynamic interface.",
  },
  {
    id: 11,
    category: "Internationalization",
    title: "Localization and Intl.",
    description:
      "Adapts websites for global audiences by translating content and adjusting designs for cultural nuances.",
  },
  {
    id: 12,
