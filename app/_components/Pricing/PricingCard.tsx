...
export default function PricingCard({ plan }: IProps) {
  return (
    <div className="relative">
      {plan.isPopluar && (
        <div className="absolute -top-4 right-12 z-30 block h-8 rounded-3xl border-2 border-zinc-800 bg-primary-green px-6 text-xs font-bold uppercase leading-7 text-zinc-100 shadow-primary-light xl:-top-8 xl:scale-105 dark:shadow-primary-dark">
          <span>Popular</span>
        </div>
      )}
      <div
