    ...
    <div className="relative overflow-hidden rounded-3xl bg-white p-7 text-zinc-800 shadow transition duration-700 dark:bg-card-dark dark:text-zinc-100">
      <div className="flex h-full flex-col">
        <div className="relative block h-52">
          ...
          />
          <div className="text-primary-violet absolute -left-0.5 top-0 z-50 h-16 w-16 rounded-br-2xl bg-white p-1 transition duration-700 dark:bg-card-dark">
        ...
        <div className="flex flex-1 flex-col justify-between pt-8">
          <div>
            ...
            <div>
              ...
              <div className="text-primary-violet flex flex-col text-sm font-semibold">
