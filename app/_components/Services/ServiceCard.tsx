...
export default function ServiceCard({ service }: IProps) {
  return (
    <div className="relative flex h-full flex-col overflow-hidden rounded-2xl bg-white p-8 text-zinc-800 opacity-100 shadow transition duration-700 dark:bg-card-dark dark:text-zinc-100">
      <div className="mb-16 text-[13px] font-medium uppercase text-zinc-800 transition duration-700 dark:text-primary-green">
      ...
      <div className="flex flex-1 flex-col justify-between">
        ...
        <div>
          ...
          <Link
            ...
            className="relative flex gap-3 align-top text-base font-bold leading-6 text-zinc-800 transition-all duration-700 hover:gap-2 hover:text-primary-green dark:text-zinc-100"
          >
