...
export default function Hero() {
  return (
    <div
      className={`${jost.className} relative flex flex-wrap overflow-x-hidden p-3 pb-14 antialiased`}
    >
      <div>
        <div className="container mx-auto grid w-full auto-rows-auto grid-cols-2 pt-32 text-zinc-900 xl:px-4 xl:pt-20 2xl:px-32">
          <div className="col-span-2 flex flex-col gap-5 xl:col-span-1 xl:justify-end">
            <div className="flex items-center justify-center gap-1 text-sm font-bold uppercase text-zinc-900 md:text-base xl:justify-start">
              <p className="dark:text-zinc-100">Hello,</p>
            ...
            <div
              className={`${jost.className} flex items-baseline justify-center gap-2 text-sm font-bold uppercase text-zinc-900 antialiased md:text-base xl:justify-start dark:text-zinc-100`}
            >
              <p>I am</p>
              <p
          ...
          <div className="relative left-1/2 col-span-2 mt-32 h-[380px] w-[380px] -translate-x-1/2 md:h-[600px] md:w-[600px] xl:col-span-1 xl:row-span-2 xl:mt-14">
            ...
            <div className="absolute -top-12 right-5 h-36 w-36 md:-right-4 md:h-48 md:w-48">
              <Image
                ...
                src={dots}
                alt="Dots Element"
                className={`dark:opacity-60 dark:invert`}
              />
            </div>
            ...
            <div>
              <ul className="relative z-[3] mx-auto w-[85%]">
                <li className="shadow-primary-light dark:shadow-primary-dark dark:bg-card-dark absolute bottom-16 flex h-[50px] w-36 items-center justify-center gap-2 rounded-[50px] border border-zinc-900 bg-white px-4 py-1.5 md:-left-12 md:bottom-28 md:h-20 md:w-56 md:border-2 dark:border-zinc-300 dark:text-zinc-100">
                ...
                <li className="shadow-primary-light dark:shadow-primary-dark dark:bg-card-dark absolute bottom-8 right-0 flex h-[50px] w-36 items-center justify-center gap-3 rounded-[50px] border border-zinc-900 bg-white px-4 py-1.5 md:-right-6 md:bottom-16 md:h-20 md:w-56 md:border-2 dark:border-zinc-300 dark:text-zinc-100">
                  <span className="flex items-center gap-1 text-center text-lg font-bold uppercase md:text-3xl">
                    330
                  </span>
                  <span className="flex flex-col text-[9px] font-bold uppercase md:text-[13px]">
          ...
          <div className="col-span-2 flex flex-col xl:col-span-1 xl:items-start xl:justify-start">
            <div className="my-12">
              <div className="mx-auto max-w-xl">
                <p className="text-center text-lg font-normal capitalize leading-8 text-zinc-600 xl:text-left dark:text-zinc-400">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed
                  do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                </p>
              </div>
              <SocialMedia justifyPosition="center" />
            </div>
            <div className="mx-auto md:flex md:items-center xl:mx-0">
              <Link
                target="_blank"
                href=""
                className="shadow-primary-light dark:shadow-primary-dark relative inline-block h-14 overflow-hidden rounded-[50px] border-2 border-zinc-900 px-10 text-center align-top text-sm font-bold uppercase leading-[50px] tracking-wider transition duration-700 before:absolute before:left-1/2 before:top-1/2 before:h-0 before:w-0 before:-translate-x-1/2 before:-translate-y-1/2 before:rounded-[50px] before:bg-primary-green before:opacity-0 before:blur-md before:transition-all before:duration-700 before:content-[''] after:z-[1] hover:text-zinc-100 hover:before:h-cv-button hover:before:w-cv-button hover:before:opacity-100 hover:before:blur-0 dark:border-zinc-300 dark:text-zinc-100"
              >
      ...
      <div className="before:shadow-primary-light after:shadow-primary-light dark:before:bg-card-dark dark:after:bg-card-dark absolute left-10 top-3/4 hidden h-5/6 w-0.5 -translate-y-3/4 bg-zinc-800 before:absolute before:left-1/2 before:top-0 before:h-7 before:w-7 before:-translate-x-1/2 before:rounded-full before:border-2 before:border-zinc-900 before:bg-white before:content-[''] after:absolute after:bottom-0 after:left-1/2 after:h-7 after:w-7 after:-translate-x-1/2 after:rounded-full after:border-2 after:border-zinc-900 after:bg-white after:content-[''] 2xl:block dark:bg-zinc-400 dark:before:border-zinc-400 dark:after:border-zinc-400"></div>
    </div>
  );
}
