        ...
        <div>
          <div className="container mx-auto grid w-full auto-rows-auto grid-cols-2 pt-32 text-zinc-800 xl:px-4 xl:pt-20 2xl:px-32">
            <div className="col-span-2 flex flex-col gap-5 xl:col-span-1 xl:justify-end">
              ...
              <h1
                className="flex items-center justify-center gap-3 text-5xl font-bold uppercase md:text-6xl xl:justify-start xl:text-8xl"
                style={{
                  textShadow:
              ...
              <div className="flex items-baseline justify-center gap-2 text-sm font-bold uppercase text-zinc-800 transition duration-700 md:text-base xl:justify-start dark:text-zinc-100">
                <p>I am</p>
                <p
