import HomeIntroTechnologiesMarquee from '@/app/_components/home-intro/home-intro-technologies-marquee'
import {
  homeIntroTechnologyListOne,
  homeIntroTechnologyListThree,
  homeIntroTechnologyListTwo,
} from '@/app/_components/home-intro/home-intro-technologies.data'
import HomeIntroTechnologiesCircularPatterns from '@/app/_components/home-intro/home-intro-technologies-circular-patterns'
import HomeIntroTechnologiesBrowserComponent from '@/app/_components/home-intro/home-intro-technologies-browser-component'

export default function HomeIntroTechnologies() {
  return (
          ...
          <div className="relative size-full">
            ...
            <div className="relative flex h-full flex-col items-center justify-end">
              ...
              <div className="z-20 mb-8 flex w-full flex-col gap-y-10 lg:mb-16">
                <HomeIntroTechnologiesMarquee technologies={homeIntroTechnologyListOne} />
                <HomeIntroTechnologiesMarquee direction="right" technologies={homeIntroTechnologyListTwo} />
                <HomeIntroTechnologiesMarquee technologies={homeIntroTechnologyListThree} />
              </div>
              <HomeIntroTechnologiesCircularPatterns />
              <HomeIntroTechnologiesBrowserComponent />
            </div>
          </div>
        </div>
      </div>
