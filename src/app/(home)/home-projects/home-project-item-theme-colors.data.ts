...
export const homeProjectItemThemeColorsData = {
  [HomeProjectItemThemesEnum.Red]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.red.600)]',
    description: 'text-red-300',
    background: 'bg-red-500',
    fill: 'fill-red-500',
  },
  [HomeProjectItemThemesEnum.Orange]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.orange.600)]',
    description: 'text-orange-300',
    background: 'bg-orange-500',
    fill: 'fill-orange-500',
  },
  [HomeProjectItemThemesEnum.Amber]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.amber.600)]',
    description: 'text-amber-300',
    background: 'bg-amber-500',
    fill: 'fill-amber-500',
  },
  [HomeProjectItemThemesEnum.Yellow]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.yellow.600)]',
    description: 'text-yellow-300',
    background: 'bg-yellow-500',
    fill: 'fill-yellow-500',
  },
  [HomeProjectItemThemesEnum.Lime]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.lime.600)]',
    description: 'text-lime-300',
    background: 'bg-lime-500',
    fill: 'fill-lime-500',
  },
  [HomeProjectItemThemesEnum.Green]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.green.600)]',
    description: 'text-green-300',
    background: 'bg-green-500',
    fill: 'fill-green-500',
  },
  [HomeProjectItemThemesEnum.Emerald]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.emerald.600)]',
    description: 'text-emerald-300',
    background: 'bg-emerald-500',
    fill: 'fill-emerald-500',
  },
  [HomeProjectItemThemesEnum.Teal]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.teal.600)]',
    description: 'text-teal-300',
    background: 'bg-teal-500',
    fill: 'fill-teal-500',
  },
  [HomeProjectItemThemesEnum.Cyan]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.cyan.600)]',
    description: 'text-cyan-300',
    background: 'bg-cyan-500',
    fill: 'fill-cyan-500',
  },
  [HomeProjectItemThemesEnum.Sky]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.sky.600)]',
    description: 'text-sky-300',
    background: 'bg-sky-500',
    fill: 'fill-sky-500',
  },
  [HomeProjectItemThemesEnum.Blue]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.blue.600)]',
    description: 'text-blue-300',
    background: 'bg-blue-500',
    fill: 'fill-blue-500',
  },
  [HomeProjectItemThemesEnum.Indigo]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.indigo.600)]',
    description: 'text-indigo-300',
    background: 'bg-indigo-500',
    fill: 'fill-indigo-500',
  },
  [HomeProjectItemThemesEnum.Violet]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.violet.600)]',
    description: 'text-violet-300',
    background: 'bg-violet-500',
    fill: 'fill-violet-500',
  },
  [HomeProjectItemThemesEnum.Purple]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.purple.600)]',
    description: 'text-purple-300',
    background: 'bg-purple-500',
    fill: 'fill-purple-500',
  },
  [HomeProjectItemThemesEnum.Fuchsia]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.fuchsia.600)]',
    description: 'text-fuchsia-300',
    background: 'bg-fuchsia-500',
    fill: 'fill-fuchsia-500',
  },
  [HomeProjectItemThemesEnum.Pink]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.pink.600)]',
    description: 'text-pink-300',
    background: 'bg-pink-500',
    fill: 'fill-pink-500',
  },
  [HomeProjectItemThemesEnum.Rose]: {
    gradient:
    ...
    shadow: 'shadow-[0_0_30px_theme(colors.rose.600)]',
