...
const ProjectItem: FC<IProjectItemProps> = (props) => {
  const { direction, projectDetails } = props
  const themeConfig = projectItemThemeColors[projectDetails.theme]

  return (
    <div
      className={`relative mx-auto flex w-full flex-col items-center ${direction === 'right' ? 'lg:flex-row' : 'lg:flex-row-reverse'}`}
    >
      <div
        ...
        <div className="flex w-full flex-col sm:mx-auto sm:w-4/5 lg:mx-10 lg:w-full">
          ...
          >
            ...
            <div className="group relative flex size-full flex-col items-center justify-between overflow-hidden rounded-xl from-black/40 to-transparent transition-all duration-300 lg:rounded-2xl dark:bg-linear-to-b">
              ...
              >
                <h3 className="max-w-[90%] text-2xl">{projectDetails.description}</h3>
                <ArrowRight size={24} />
              </div>
              <Image
          ...
          <div className="flex">
            <div
              ...
              className={clsx(
                ...
                projectItemThemeColors[projectDetails.theme].background
              )}
            />
            <div className="flex flex-col items-start">
              <div className="flex items-center gap-3">
                <h3 className="text-foreground text-2xl font-bold">{projectDetails.title}</h3>
              </div>
                  ...
                  <li key={feature.id} className="flex items-center text-sm">
                    <svg
                      ...
                      className={clsx(
                        ...
                        projectItemThemeColors[projectDetails.theme].fill
                      )}
                    >
