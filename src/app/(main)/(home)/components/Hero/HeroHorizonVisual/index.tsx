const HeroHorizonVisual = () => {
  return (
    <div className="relative z-[19] mt-8 h-60 w-full">
      <div
      ...
      >
        ...
        <div
          className="bg-white-1 absolute right-[-510px] bottom-[-759px] left-[-532px] aspect-[2.346820809248555/1] h-[956px] rounded-[100%] shadow-[inset_0_2px_20px_#fff,0_-10px_50px_1px_#ffffff7d] dark:bg-[#0a0a0a]"
          style={{
            boxShadow:
              'rgb(255, 255, 255) 0px 2px 20.246px inset, rgba(255, 255, 255, 0.494) 0px -10px 50.246px 1px',
          }}
        />
      </div>
    </div>
...
export default HeroHorizonVisual
