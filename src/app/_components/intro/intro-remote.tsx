...
export default function IntroRemote() {
  return (
    <div className="group relative col-span-6 flex size-full transform-gpu flex-col justify-between overflow-hidden rounded-xl [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] max-md:h-[32rem] md:col-span-3 md:row-span-2 lg:col-span-2 dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:[border:1px_solid_rgba(255,255,255,.1)]">
        ...
        <>
          <svg width="0" height="0">
            <linearGradient id="blue-gradient" x1="50%" y1="0%" x2="50%" y2="100%">
              ...
              <stop stopColor="#7b9cda" offset="60%" />
            </linearGradient>
          </svg>
          <MapPin
      ...
      <div className="pointer-events-none absolute bottom-0 z-10 flex w-full translate-y-10 transform-gpu flex-row items-center p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100">
        <a
          href="/contact"
          data-slot="button"
