...
import { collaborators } from '@/app/_components/intro/intro-collaboration.data'
import { clsx } from 'clsx'
import IntroCollaborationPattern from '@/app/_components/intro/intro-collaboration-pattern'
import Link from 'next/link'

export default function IntroCollaboration() {
  ...
  return (
    <div
      ...
      className="group relative col-span-6 flex size-full transform-gpu flex-col justify-between overflow-hidden rounded-xl [box-shadow:0_0_0_1px_rgba(0,0,0,.03),0_2px_4px_rgba(0,0,0,.05),0_12px_24px_rgba(0,0,0,.05)] max-md:h-[21rem] md:col-span-3 lg:col-span-4 dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] dark:[border:1px_solid_rgba(255,255,255,.1)]"
    >
      ...
      <div className="pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:-translate-y-10">
        <>
          <svg width="0" height="0">
            <linearGradient id="pink-gradient" x1="50%" y1="0%" x2="50%" y2="100%">
              <stop stopColor="#edeffd" offset="20%" />
              <stop stopColor="#da7bda" offset="60%" />
            </linearGradient>
          </svg>
          <HeartHandshake
            className="size-12 origin-left transition-all duration-300 ease-in-out group-hover:scale-75"
