...
import { IntroTechnologiesMarqueePropsType } from '@/app/_components/intro/intro-technologies-marquee-props.type'

export default function IntroTechnologiesMarquee(props: IntroTechnologiesMarqueePropsType) {
