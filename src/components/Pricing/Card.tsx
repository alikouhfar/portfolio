      ...
      <div className="flex h-full flex-col rounded-[30px] border border-zinc-600 p-10 pt-9 transition-all hover:border-theme">
        <div className="mb-9 flex flex-col justify-between border-b border-zinc-600 pb-5 laptop:min-h-44">
          <div className="mb-8 flex items-start justify-between gap-1">
            <h4
              className={`m-0 flex-[2] text-lg uppercase text-white ${language === "en" ? "font-light" : "font-semibold"}`}
            >
        ...
        <ul className="mb-20 flex list-square flex-col gap-4">
        ...
        <a
          href="#"
          className={`mt-auto inline-flex cursor-pointer items-center justify-center rounded-[30px] border-2 border-theme bg-theme px-14 py-3 text-center uppercase text-zinc-900 transition-all hover:border-theme hover:bg-transparent hover:text-theme ${language === "en" ? "font-medium" : "text-sm font-bold"}`}
        >
