...
const Header = () => {
  ...
  return (
    <div className="fixed inset-x-0 top-2.5 z-50 mx-auto mt-1.5 flex w-full max-w-7xl items-center justify-between px-6 py-1.5 pr-4 lg:top-8">
      {/* <div>LOGO</div> */}
              ...
              >
                ...
                {isActive(item.href) && (
                  <div className="bg-primary/5 absolute inset-0 -z-10 w-full rounded-full">
                    <div className="bg-primary absolute -top-2.25 left-1/2 h-1 w-8 -translate-x-1/2 rounded-t-full">
